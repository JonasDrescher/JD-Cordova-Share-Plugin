cordova.define("jdcordova-share-plugin", function(require, exports, module) {
...
SocialSharing.prototype.shareViaPinterest = function (message, fileOrFileArray, url, successCallback, errorCallback) {
    cordova.exec(successCallback, this._getErrorCallback(errorCallback, "shareViaPinterest"), "SocialSharing", "shareViaPinterest", [message, null, this._asArray(fileOrFileArray), url]);
};
